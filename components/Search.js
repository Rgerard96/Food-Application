    ...
    <div className='mb-8 overflow-hidden'>
      <div className='container mx-auto px-4 sm:px-5'>
        <div className='flex flex-col items-center justify-between rounded-lg border bg-white p-5 md:h-16 md:flex-row md:p-0'>
          <div className='mb-3 flex h-full w-full items-center rounded-lg border px-4 py-2 md:mb-0 md:rounded-none md:border-y-0 md:border-l-0 md:py-0'>
          ...
          <div className='mb-3 flex h-full w-full items-center justify-between rounded-lg border px-4 py-2 md:mb-0 md:rounded-none md:border-y-0 md:border-l-0 md:py-0'>
          ...
          <div className='w-full px-0 text-center sm:px-4 md:w-max'>
