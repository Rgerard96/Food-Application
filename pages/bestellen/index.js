  ...
  return (
    <div>
      ...
      <SlideOver
        ...
        type={type}
      />
      <div className='container mx-auto mb-8 px-4 sm:px-5'>
        <div className='h-64 w-full rounded-lg bg-blue-500'></div>
      </div>
      <div>
        <Search />
      </div>
      <div className='container mx-auto mb-5 flex items-center justify-between px-4 sm:px-5'>
      ...
      <div className='container mx-auto grid grid-cols-1 gap-5 px-4 sm:grid-cols-2 sm:px-5 lg:grid-cols-3 xl:grid-cols-4'>
        <SellerCard />
        <SellerCard />
        <SellerCard />
        <SellerCard />
